...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("iwdc4pga")

  // remove
  collection.schema.removeField("dvzpkx5c")

  // remove
  collection.schema.removeField("93dwzizm")

  // remove
  collection.schema.removeField("e8zrdl3b")
