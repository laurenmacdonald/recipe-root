...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("qivypw4b")

  // remove
  collection.schema.removeField("iitrn3cz")

  // remove
  collection.schema.removeField("7bcvuajn")

  // remove
  collection.schema.removeField("jjwopm78")
