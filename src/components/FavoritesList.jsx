...
export default function FavoritesList() {
  ...
  function filterRecipes(tagsToMatch, categoryToMatch) {
    return recipeData.filter((recipe) => {
      ...
      return matchesTags && matchesCategory && isFavorite;
    });
  }

  let filteredData = useMemo(
    () => filterRecipes(filterTags, filterCategory),
    [filterTags, filterCategory, recipeData]
  );
